...
if __name__ == "__main__":
	...
	def statistic_count(rdd, baseType_check, semanticType_check, validation_check):
		rdd.map(lambda row: (row, 1)) \
			...
			.saveAsTextFile("col12_statistic_count.out")
